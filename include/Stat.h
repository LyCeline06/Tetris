...
class Stat
{
	...
	public :
		Stat() = default;
		Stat(char *msg1, int nb, int score_base, SDL_Renderer* renderer,int ai=0);
...
class Score : public Stat
{
	public:
		Score() = default;
		Score(char *msg1, int nb, int score_base, SDL_Renderer* renderer,int ai=0);
...
class Level : public Stat
{
	...
	public:
		Level() = default;
		Level(char *msg1, int nb, int score_base, SDL_Renderer* renderer,int ai=0);
...
class Lines : public Stat
{
	public:
		Lines() = default;
		Lines(char *msg1, int nb, int score_base, SDL_Renderer* renderer,int ai=0);
